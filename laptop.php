...
<body>
    ...
    <section id="Featured">
        ...
        <div class="row">
            <div class="product">
                <img class="" src="assets/images/laptop.jpg" alt="amazontv">
                <div class="star">
              ...
              <h5 class="p-name">hp laptop</h5>
                <h4 class="p-price">$500.9</h4>
                <button class="buy-now">Buy Now</button>
            </div>
            <div class="product">
                <img class="" src="assets/images/lap2.jpg" alt="amazonLaptop">
                <div class="star">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                ...
                <h5 class="p-name"> dell Laptops</h5>
                <h4 class="p-price">$400.99</h4>
                <button class="buy-now">Buy Now</button>
            </div>
            <div class="product">
                <img class="" src="assets/images/lap3.jpg" alt="amazonPhone">
                <div class="star">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                ...
                <h5 class="p-name">hp probook</h5>
              <h4 class="p-price">$500.99</h4>
                <button class="buy-now">Buy Now</button>
            </div>
 <div class="product">
                <img class="" src="assets/images/lab4.jpg" alt="amazonCamera">
                <div class="coll">
                   <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                ...
                <h5 class="p-name">Elite laptops</h5>
                <h4 class="p-price">$400.99</h4>
                <button class="buy-now">Buy Now</button>
            </div>
            <div class="product">
                ...
                <div class="coll">
                    ...
                    <h5 class="p-name">lenovel laptops</h5>
        ...
        <div class="row">
            <div class="product">
                <img class="" src="assets/images/lap5.jpg" alt="amazontv">
                <div class="star">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                ...
                <h5 class="p-name">Acer laptop</h5>
                <h4 class="p-price">$300.9</h4>
                <button class="buy-now">Buy Now</button>
            </div>
            <div class="product">
                <img class="" src="assets/images/lap6.jpg" alt="amazonLaptop">
                <div class="star">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                ...
                <h5 class="p-name">Apple laptop</h5>
                <h4 class="p-price">$1000.99</h4>
                <button class="buy-now">Buy Now</button>
            </div>
            <div class="product">
                <img class="" src="assets/images/amazonLaptop.webp" alt="amazonPhone">
                <div class="star">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                ...
                <h5 class="p-name">Hp laptop</h5>
                <h4 class="p-price">$390.99</h4>
                <button class="buy-now">Buy Now</button>
            </div>
            <div class="product">
                <img class="" src="assets/images/lap10.jpg" alt="amazonCamera">
                <div class="coll">
                    <div class="star">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                    ...
                    <h5 class="p-name">Microsoft</h5>
                    <h4 class="p-price">$1200.23</h4>
                    <button class="buy-now">Buy Now</button>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="product">
                <img class="" src="assets/images/lap11.jpg" alt="amazontv">
                <div class="star">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
            ...
            <div class="product">
                <img class="" src="assets/images/lap12.jpg" alt="amazonLaptop">
                <div class="star">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                ...
                <h5 class="p-name">Sumsung</h5>
                <h4 class="p-price">$230.99</h4>
                <button class="buy-now">Buy Now</button>
            </div>
            <div class="product">
                <img class="" src="assets/images/lap13.jpg" alt="amazonPhone">
                <div class="star">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                ...
                <h5 class="p-name">Microsoft laptop</h5>
                <h4 class="p-price">$1000.99</h4>
                <button class="buy-now">Buy Now</button>
            </div>
            <div class="product">

                <img class="" src="assets/images/lap14.jpg" alt="amazonCamera">
                <div class="coll">
                    <div class="star">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                    ...
                    <h5 class="p-name">LG laptop</h5>
                    <h4 class="p-price">$ 234.84</h4>
                    <button class="buy-now">Buy Now</button>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="product">
                <img class="" src="assets/images/lap7.jpg" alt="amazontv">
                <div class="star">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                ...
                <h5 class="p-name">lenovo laptop</h5>
                <h4 class="p-price">$299.9</h4>
                <button class="buy-now">Buy Now</button>
            </div>
            <div class="product">
                <img class="" src="assets/images/lap8.jpg" alt="amazonLaptop">
                <div class="star">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                ...
                <h5 class="p-name">Asus laptop</h5>
                <h4 class="p-price">$1004.99</h4>
                <button class="buy-now">Buy Now</button>
            </div>
            <div class="product">
                <img class="" src="assets/images/lap9.jpg" alt="amazonPhone">
                <div class="star">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                ...
                <h5 class="p-name">Acer Swift14</h5>
                <h4 class="p-price">$399.99</h4>
                <button class="buy-now">Buy Now</button>
            </div>
            <div class="product">
                <img class="" src="assets/images/toshiba.png" alt="amazonCamera">
                <div class="coll">
                    <div class="star">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
...
<nav class="Previous">
    <ul class="pagination">
        <li class="page-item"><a class="page-link" href="phone.html">Previous</a></li>
        <li class="page-item"><a class="page-link" href="tv.html">Next</a></li>
    </ul>
</nav>
    </section>
    <footer>
