...
$product = $_SESSION['cart'][$key]; //array w product
...
$statement2 = $conn->prepare("INSERT INTO order_item(order_id,product_id,product_name,product_image,product_price,product_quantity,user_id,order_date)
            VALUES (?,?,?,?,?,?,?,?)");
$statement2->bind_param('iissiiis',$order_id,$product_id,$product_name,$product_image,$product_price,$product_quantity,$user_id,$order_date);
$statement2->execute();

}
/*

remove evry thing from cart
